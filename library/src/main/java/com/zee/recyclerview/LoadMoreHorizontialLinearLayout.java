 ...
 */
class LoadMoreHorizontialLinearLayout extends LinearLayout implements ILoadMoreLinearLayout {
    ...
    public LoadMoreHorizontialLinearLayout(Context context) {
        super(context);
    }

    public LoadMoreHorizontialLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
