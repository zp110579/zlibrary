...
public class NotificationBean {
    ...
    public NotificationManager getManager() {
        if (mManager == null) {
            mManager = (NotificationManager) UIUtils.getSystemService(Context.NOTIFICATION_SERVICE);
        }
        return mManager;
    }
    ...
    private NotificationCompat.Builder getNotificationCompat(String title, String content, int icon) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            builder = new NotificationCompat.Builder(UIUtils.getApplication(), CHANNEL_ID);
        } else {
            //注意用下面这个方法，在8.0以上无法出现通知栏。8.0之前是正常的。这里需要增强判断逻辑
            builder = new NotificationCompat.Builder(UIUtils.getApplication());
    ...
    private Notification.Builder getChannelNotification(String title, String content, int icon) {
        Notification.Builder builder = new Notification.Builder(UIUtils.getApplication(), CHANNEL_ID);
     ...
     * @return
     */
    public NotificationBean setOngoing(boolean ongoing) {
     ...
     * @return
     */
    public NotificationBean setContent(RemoteViews remoteViews) {
     ...
     * @return
     */
    public NotificationBean setContentIntent(PendingIntent intent) {
        this.intent = intent;
        return this;
    }

    public NotificationBean setContentIntent(Intent intent) {
        intent.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        PendingIntent resultPendingIntent = PendingIntent.getActivity(UIUtils.getCurActivity(), 2, intent, PendingIntent.FLAG_UPDATE_CURRENT);
        this.intent = resultPendingIntent;
        return this;
    }

    public NotificationBean setContentActivity(Class<?> cls) {
    ...
    public NotificationBean setAdapter(NotificationAdapter adapter) {
        setContent(adapter.getRemoteViews());
        return this;
    }
     ...
     * @return
     */
    public NotificationBean setTicker(String ticker) {
        this.ticker = ticker;
        return this;
    }
     ...
     * @return
     */
    public NotificationBean setPriority(int priority) {
     ...
     * @return
     */
    public NotificationBean setOnlyAlertOnce(boolean onlyAlertOnce) {
     ...
     * @return
     */
    public NotificationBean setWhen(long when) {
        this.when = when;
        return this;
    }
     ...
     * @return
     */
    public NotificationBean setSound(Uri sound) {
        this.sound = sound;
        return this;
    }
     ...
     * @return
     */
    public NotificationBean setDefaults(int defaults) {
     ...
     * @return
     */
    public NotificationBean setVibrate(long[] pattern) {
     ...
     * @return
     */
    public NotificationBean setFlags(int... flags) {
        this.flags = flags;
        return this;
    }
}
