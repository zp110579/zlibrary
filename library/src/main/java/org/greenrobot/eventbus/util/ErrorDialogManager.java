 ...
 * <li>Use one of {@link #attachTo(FragmentActivity)}, {@link #attachTo(FragmentActivity, boolean)} or
 * {@link #attachTo(FragmentActivity, boolean, Bundle)} in your Activity, typically in onCreate.</li>
 * </ol>
 * 
...
public class ErrorDialogManager {
    ...
    public static class HoneycombManagerFragment extends Fragment {
        ...
        public void onEventMainThread(ThrowableFailureEvent event) {
            ...
            DialogFragment errorFragment = (DialogFragment) factory.prepareErrorFragment(event,
        ...
        public static void attachTo(FragmentActivity activity, Object executionScope, boolean finishAfterDialog, Bundle argumentsForErrorDialog) {
    ...
    public static void attachTo(FragmentActivity activity) {
        attachTo(activity, false, null);
    }

    /** Scope is limited to the activity's class. */
    public static void attachTo(FragmentActivity activity, boolean finishAfterDialog) {
        attachTo(activity, finishAfterDialog, null);
    }

    /** Scope is limited to the activity's class. */
    public static void attachTo(FragmentActivity activity, boolean finishAfterDialog, Bundle argumentsForErrorDialog) {
