...
package com.zee.scan.zxing.camera;
...
public final class CameraManager {
    ...
    private static final int MAX_FRAME_WIDTH = 750; // = 5/8 * 1920
    private static final int MAX_FRAME_HEIGHT = 750; // = 5/8 * 1080
    ...
    public synchronized Rect getFramingRect() {
        if (framingRect == null) {
            ...
            int topOffset = (screenResolution.y - height) / 2 - dpToPx(50f);
