...
public final class SmoothScrollTimerTask extends TimerTask {
    ...
    public SmoothScrollTimerTask(ZxWheelView wheelView, int offset) {
    ...
    public final void run() {
        ...
        if (Math.abs(realTotalOffset) <= 1) {
            ...
            wheelView.getHandler().sendEmptyMessage(com.contrarywind.timer.MessageHandler.WHAT_ITEM_SELECTED);
        } else {
