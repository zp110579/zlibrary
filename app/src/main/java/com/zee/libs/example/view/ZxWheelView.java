 ...
 * 3d滚轮控件
 */
public class ZxWheelView extends View {
    ...
    private com.contrarywind.view.WheelView.DividerType dividerType;//分隔线类型
    ...
    public ZxWheelView(Context context) {
        this(context, null);
    }

    public ZxWheelView(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public void smoothScroll(com.contrarywind.view.WheelView.ACTION action) {//平滑滚动的实现
        cancelFuture();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //绘制中间两条横线
        if (dividerType == com.contrarywind.view.WheelView.DividerType.WRAP) {//横线长度仅包裹内容
            float startX;
            float endX;
        ...
        } else if (dividerType == com.contrarywind.view.WheelView.DividerType.CIRCLE) {
            //分割线为圆圈形状
